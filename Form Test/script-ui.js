$(function(){
    ...
    function addUser(){
        ...
        if(valid){
            ...
            "</tr>");
            dialog.dialog("close");
            window.alert('Le Pseudo est \"' + name.val() + '\" et le Mots de Passe est \"'+ password.val() + '\".')
            window.alert('\"' + name.val() + '\" et le Mots de Passe est \"'+ password.val() + '\".')
            //  LOGIN       : "LOGIN :: Pseudo :: name.val() MdP : password.val() "
            //  INSCRIPTION : "INSCRIPTION :: Pseudo : name.val() MdP : password.val() "
        }
        return valid;
    }
